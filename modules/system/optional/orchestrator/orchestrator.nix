      ...
      in
      {
        ...
        config = {
          networking.firewall = {
            ...
            ++ lib.optionals cfg.publicDns [ 53 ]; # UIs, DNS (conditional)
            allowedUDPPorts = [
              443
              4646
              8501
          ...
          systemd.services = {
            consul.serviceConfig.RestartSec = 2; # Give time to decrypt, Nomad already has this
            coredns.serviceConfig.RestartSec = 2;
          };
