                      ...
                      ESP = {
                        ...
                        content = {
                          ...
                          mountOptions = [
                            "fmask=0077"
                            "dmask=0077"
                          ]; # Solves warning: Random seed file '/boot/loader/random-seed' is world accessible, which is a security hole!
                        };
                      };
                      root =
                        let
                        ...
                        in
                        if (config.my.disks.encryptRoot != false) then
                          {
                            size = "100%";
                            content = {
                              type = "luks";
                              ...
                              settings = {
                                ...
                                crypttabExtraOpts =
                                  ...
                                  # TPM2
                                  #
                                  else if tpm2Enabled then
                                    [
                                      "tpm2-device=auto"
                                      "tpm2-measure-pcr=yes"
                                    ] # tpm2-measure-pcr is required for PCR15
